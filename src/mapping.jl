...
function mapclimgrid(;region::String="auto", states::Bool=true, llon=[], rlon=[], slat=[], nlat=[])
    ...
    elseif lowercase(region) == "northamerica" || lowercase(region) == "na"
        m = basemap[:Basemap](projection="lcc", resolution="l", llcrnrlon=-135.5, llcrnrlat=1.0, urcrnrlon=-10.566, urcrnrlat=46.352, lon_0=-95, lat_1=50, rsphere = (6378137.00, 6356752.3142))

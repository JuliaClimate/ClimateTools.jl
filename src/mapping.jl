...
function mapclimgridR(C::ClimGrid; region::String = "auto", level = 1)
  ...
  elseif region == "Quebec"
      m = basemap[:Basemap](width=6500000,height=5000000, rsphere = (6378137.00, 6356752.3142),      resolution = "c", projection = "lcc", lat_1 = 45., lat_2 = 55, lat_0 = 62, lon_0 = -75.)

...
@test griddata(C, C2)[1].data[1, 1, 1] == 219.2400638156467
@test griddata(C, C2, min=0.0, max=0.0)[1].data[1, 1, 1] == 0.0
@test griddata(C, lon, lat)[1].data[1, 1, 1] == 219.2400638156467
@test griddata(C, lon, lat, min=0.0, max=0.0)[1].data[1, 1, 1] == 0.0
